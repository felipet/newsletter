...
use crate::{domain::SubscriberEmail, routes::error_chain_fmt, EmailClient};
use actix_web::{
...
pub async fn publish_newsletter(
    ...
    let credentials = basic_authentiaction(request.headers()).map_err(PublishError::AuthError)?;
...
fn basic_authentiaction(headers: &HeaderMap) -> Result<Credentials, anyhow::Error> {
    ...
    // Split into two segments, using ':' asa delimiter.
